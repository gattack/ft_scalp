#!/usr/bin/env bash
# Runs monthly backtests for the full 2-year window: Apr 2024 – Apr 2026.
# Usage: bash user_data/scripts/run_2year_backtest.sh [STRATEGY]
...
LOGFILE="${RESULTS_DIR}/run_2year_${STRATEGY}.log"
...
echo "=== 2-year backtest: $STRATEGY  $(date) ===" | tee -a "$LOGFILE"
